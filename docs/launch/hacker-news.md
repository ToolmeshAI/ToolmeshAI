...
Title:
`Show HN: mcp-saas-foundry – a forkable starter blueprint for SaaS-focused MCP servers`

Why first:

- strongest novelty-to-utility ratio
- easiest repo to explain in one sentence
- most likely to pull users into the rest of the portfolio
