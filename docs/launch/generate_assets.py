...
REPOS = {
    ...
    "openapi-to-context": {
        "tagline": "Turn one OpenAPI file into a compact Markdown or JSON brief for agents, builders, and API workflow handoffs.",
        "eyebrow": "API Context Utility",
        "accent": "#2A6F97",
        "accent_soft": "#B8D8EA",
        "shape": "pages",
        "command": ["node", "src/cli.mjs", "examples/petstore.yaml", "--tag", "workflows", "--include-schemas"],
    },
    "llms-txt-builder": {
        "tagline": "Zero-dependency CLI for drafting a publishable llms.txt from repo metadata, selected docs, and example links.",
        "eyebrow": "Generation Utility",
        "accent": "#6C9A8B",
        "accent_soft": "#CFE5DE",
        "shape": "pages",
        "command": [
            "node",
            "bin/llms-txt-builder.js",
            "--title",
            "llms-txt-builder",
            "--summary",
            "Build a publishable llms.txt draft from repo metadata and doc paths.",
            "--repo-url",
            ...
            "--notes",
            "Draft generated locally|Validate with llms-txt-check before publish",
        ],
    },
    "mcp-http-smoke": {
    ...
    "release-brief-action": {
        "tagline": "Small GitHub Action that turns a git ref range into a release brief and JSON manifest for human or agent handoff.",
        "eyebrow": "Release Action",
        "accent": "#7A4EAB",
        "accent_soft": "#D8C6EB",
        "shape": "workflow",
        "command": ["node", "scripts/demo.js"],
